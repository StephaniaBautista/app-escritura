...
function PlanCards() {
  ...
  const plans = [
    ...
    },
    {
      ...
      highlight: false,
      cta: t('pricingPage.startPremiumChat'),
      features: [
    ...
    },
    {
      ...
      period: t('pricing.perMonth'),
      description: t('pricing.premiumCharacter.desc'),
      highlight: false,
      cta: t('pricingPage.startPremiumCharacter'),
      features: [
        t('pricing.premiumCharacter.f1'),
        t('pricing.premiumCharacter.f2'),
        t('pricing.premiumCharacter.f3'),
        t('pricing.premiumCharacter.f4'),
      ],
    },
    {
...
function ComparisonTable() {
  ...
  const planNames = [
    t('pricing.free.name'),
    t('pricing.medium.name'),
    t('pricing.pro.name'),
    t('pricing.premiumChat.name'),
    t('pricing.premiumCharacter.name'),
    t('pricing.premiumFull.name'),
  ]

  const comparisonRows = [
    { feature: t('comparison.basicWriting'), values: [true, true, true, true, true, true] },
    { feature: t('comparison.notes'), values: ['Básicas', 'Sin límite', 'Sin límite', 'Sin límite', 'Sin límite', 'Sin límite'] },
    { feature: t('comparison.characters'), values: ['5 por historia', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado'] },
    { feature: t('comparison.guidedMode'), values: [true, true, true, true, true, true] },
    { feature: t('comparison.branches'), values: ['1 extra', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado'] },
    { feature: t('comparison.timeline'), values: ['Sencilla', 'Avanzada', 'Avanzada', 'Avanzada', 'Avanzada', 'Avanzada'] },
    { feature: t('comparison.relations'), values: ['3 personajes', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado'] },
    { feature: t('comparison.evolution'), values: [false, false, true, true, true, true] },
    { feature: t('comparison.lore'), values: ['1 entrada', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado'] },
    { feature: t('comparison.subplots'), values: [false, true, true, true, true, true] },
    { feature: t('comparison.statistics'), values: ['Básicas', 'Avanzadas', 'GitHub-style', 'GitHub-style', 'GitHub-style', 'GitHub-style'] },
    { feature: t('comparison.exportPdf'), values: [true, true, true, true, true, true] },
    { feature: t('comparison.exportHtml'), values: [false, true, true, true, true, true] },
    { feature: t('comparison.sharing'), values: [true, true, true, true, true, true] },
    { feature: t('comparison.versions'), values: ['20/doc', '50/doc', 'Ilimitado', 'Ilimitado', 'Ilimitado', 'Ilimitado'] },
    { feature: t('comparison.autoVersion'), values: [false, 'Mensual, Semanal', 'Hora, Día, Semana, Mes', 'Hora, Día, Semana, Mes', 'Hora, Día, Semana, Mes', 'Hora, Día, Semana, Mes'] },
    { feature: t('comparison.chatAi'), values: [false, false, false, true, false, true] },
    { feature: t('comparison.characterAi'), values: [false, false, false, false, true, true] },
    { feature: t('comparison.suggestions'), values: [false, false, false, false, false, true] },
    { feature: t('comparison.tokens'), values: ['-', '-', '-', '~100K', '~200K', '~400K'] },
    { feature: t('comparison.payAsYouGo'), values: ['-', '-', '-', '$2/50K', '$2/50K', '$2/50K'] },
  ]
